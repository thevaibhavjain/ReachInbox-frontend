...
function SideBar({ onMenuItemClick }: any) {
  ...
  return (
    <div className="dark:bg-[#101113] bg-white overflow-y-scroll no-scrollbar h-screen w-14 flex flex-col justify-between items-center py-4 border-r-2 dark:border-[#343A40] border-[#E0E0E0] left-0 top-0 fixed z-10">
      ...
      <div className="text-[#AEAEAE] text-2xl space-y-10">
        <div className={`cursor-pointer p-1 ${selectedItem === '/' ? 'dark:bg-white bg-gray-600 rounded-lg' : ''}`} onClick={() => handleMenuItemClick('/')}>
          <RiHome5Fill />
        </div>
